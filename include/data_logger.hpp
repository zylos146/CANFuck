#ifndef WEB_LOGGER_INCLUDES_H
#define WEB_LOGGER_INCLUDES_H
...
#define WEBLOG_LOG_FORMAT(format)  "[%s:%u] %s(): " format "\r\n", pathToFileName(__FILE__), __LINE__, __FUNCTION__
  ...
  #define weblog_v(format, ...) \
    ...
    wlog.log(WebLogLevel::VERBOSE, WEBLOG_LOG_FORMAT(format), ##__VA_ARGS__)
#else
  ...
  #define weblog_d(format, ...) \
    log_printf(ARDUHAL_LOG_FORMAT(V, format), ##__VA_ARGS__); \
    wlog.log(WebLogLevel::DEBUG, WEBLOG_LOG_FORMAT(format), ##__VA_ARGS__)
#else
  ...
  #define weblog_i(format, ...) \
    ...
    wlog.log(WebLogLevel::INFO, WEBLOG_LOG_FORMAT(format), ##__VA_ARGS__)
#else
  ...
  #define weblog_w(format, ...) \
    ...
    wlog.log(WebLogLevel::WARN, WEBLOG_LOG_FORMAT(format), ##__VA_ARGS__)
#else
  ...
  #define weblog_e(format, ...) \
    ...
    wlog.log(WebLogLevel::ERROR, WEBLOG_LOG_FORMAT(format), ##__VA_ARGS__)
#else
